...
1. **Download and execute main setup script:** Execute the following command in your terminal from the project directory.
    ```
    curl -OJL https://raw.githubusercontent.com/ELEVATE-Project/entity-management/refs/heads/main/src/documentation/3.4.0/dockerized/script/ubuntu/entity_setup.sh && chmod +x entity_setup.sh && sudo ./entity_setup.sh
    ```
